...
import com.taotao.vo.UploadFileVO;
...
public class UploadFileController {
     ...
     * 上传文件
     * @param file 上传的文件
     * @return 结果VO 用于封装消息(是否成功),数据(前端回显)
     * */
    @RequestMapping(value = "uploadFile",method = RequestMethod.POST)
    @ResponseBody
    public ResultVO uploadFile(@Param("file")MultipartFile file) throws IOException {
        //本地使用,上传位置
        String rootPath ="/Users/apple/Documents/neteasy/taotao/taotao-manage/taotao-manage-web/target/taotao-manage-web/uploadFile";
        //专门用于img的src标签的路径!!!
        String srcPath ="http://localhost:8080/uploadFile";
        ...
        //完整的url
        String fileUrl = srcPath + "/"+dateDirs+ "/"+newFilename;
